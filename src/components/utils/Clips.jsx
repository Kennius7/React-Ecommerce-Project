...
const Clips = ({ clip, imgsrc }) => {
  return (
   <>
      <div className='relative rounded-xl overflow-hidden group cursor-pointer transition-all 
        duration-300 sm:w-32 sm:h-32 xs:w-20 xs:h-20 h-15 w-15'>
        <img
            src={imgsrc}
            alt="img/clips"
        ...
        />
        <div className='bg-white/75 blur-effect-theme absolute top-11 left-11 md:top-8 md:left-8 
          sm:top-4 sm:left-5 right-0 opacity-100 z-[100] w-8 h-8 md:w-5 md:h-5 flex items-center 
